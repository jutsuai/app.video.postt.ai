...
import { FaTrash as RemoveIcon } from "react-icons/fa6";
    ...
    >
      ...
      >
        {dropzoneState?.isDragActive ? (
          <div className="flex w-full  transition-all duration-300 animate-in flex-col items-center justify-center pb-4 pt-3">
            <FileSvgDraw isDragging={true} />
          </div>
        ) : (
          children
        )}
